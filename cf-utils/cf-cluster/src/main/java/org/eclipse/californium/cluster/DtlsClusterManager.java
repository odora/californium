...
public class DtlsClusterManager {
	...
	public DtlsClusterManager(DtlsManagedClusterConnector clusterConnector, DtlsClusterManagerConfig configuration,
		...
		this.tag = clusterConnector.getNodeID() + " (" + clusterConnector.getManagementProtocol() + ")";
		this.secure = DtlsManagedClusterConnector.PROTOCOL_MANAGEMENT_DTLS
				.equals(clusterConnector.getManagementProtocol());
