 ...
 * </dl>
 */
public class K8sManagementDiscoverClient implements ClusterNodesDiscover {

	/**
	 * Logger.
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(K8sManagementDiscoverClient.class);
	 ...
	 *             http GET
	 */
	public void getPods() throws IOException, GeneralSecurityException {
