...
public class DtlsClusterHealthLogger extends DtlsHealthLogger implements DtlsClusterHealth {
	...
	private final SimpleCounterStatistic sendingClusterManagementMessage = new SimpleCounterStatistic("sent cluster mgmt", align);
	private final SimpleCounterStatistic receivingClusterManagementMessage = new SimpleCounterStatistic("recv cluster mgmt", align);
